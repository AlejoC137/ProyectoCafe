...
function MenuCheckListCocina(props) {
    ...
    const updateFilteredItems = () => {
        const desechablesP = items.desechables.filter(item => item.Estado === 'PENDIENTE' && item.Area === 'COMIDA');
        const ingredienteP = items.ingrediente.filter(item => item.Estado === 'PENDIENTE' && item.Area === 'COMIDA');
        const produccionExternaP = items.produccionExterna.filter(item => item.Estado === 'PENDIENTE' && item.Area === 'COMIDA');
        const produccionInternaP = items.produccionInterna.filter(item => item.Estado === 'PENDIENTE' && item.Area === 'COMIDA');
    ...
    return (
        <div className="container mx-auto py-8">
            ...
            <div className="mt-4 w-full flex flex-col md:flex-row justify-around">
                {filteredItemsDesechablesP.length > 0 && (
                    <div className="bg-gray-100 border p-4 rounded w-full md:w-1/2 m-2">
                        ...
                        <button
                            ...
                            onClick={() => copyToClipboard(filteredItemsDesechablesP)}
                        >
                ...
                {filteredItemsIgredienteP.length > 0 && (
                    <div className="bg-gray-100 border p-4 rounded w-full md:w-1/2 m-2">
                        ...
                        <button
                            className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-2"
                            onClick={() => copyToClipboard(filteredItemsIgredienteP)}
                        >
                            Copiar al Portapapeles
                        </button>
                    </div>
                ...
                {filteredItemsProduccionExternaP.length > 0 && (
                    <div className="bg-gray-100 border p-4 rounded w-full md:w-1/2 m-2">
                        ...
                        <button
                            className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-2"
                            onClick={() => copyToClipboard(filteredItemsProduccionExternaP)}
                        >
                            Copiar al Portapapeles
                        </button>
                    </div>
                ...
                {filteredItemsProduccionInternaP.length > 0 && (
                    <div className="bg-gray-100 border p-4 rounded w-full md:w-1/2 m-2">
                        ...
                        <button
                            className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-2"
                            onClick={() => copyToClipboard(filteredItemsProduccionInternaP)}
                        >
                            Copiar al Portapapeles
                        </button>
                    </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                {/* <div className="m-1">
                    <CardsCheckList
                        info={items.desechables.filter(item => item.Area === 'COMIDA')}
                        tittle='DESECHABLES'
                ...
                <div className="m-1">
                    <CardsCheckList
                        info={items.ingrediente.filter(item => item.Area === 'COMIDA')}
                        tittle='INGREDIENTE'
                        sourceImg="https://res.cloudinary.com/dwcp7dk9h/image/upload/v1710996709/PERCHERO_02-02_g4pqcy.png"
                    />
                </div>
                {/* <div className="m-1">
                    <CardsCheckList
                        info={items.produccionExterna.filter(item => item.Area === 'COMIDA')}
                ...
                <div className="m-1">
                    <CardsCheckList
                        info={items.produccionInterna.filter(item => item.Area === 'COMIDA')}
